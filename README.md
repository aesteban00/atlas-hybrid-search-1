...
# Angel: ERROR "Collecting page data  ..ReferenceError: document is not defined" in lottie.js (https://github.com/airbnb/lottie-web/issues/2739)
# fix using node v 20.10.0 LTS (https://stackoverflow.com/questions/44803721/how-to-brew-install-specific-version-of-node) ... use: brew install node@20 -> brew unlink node -> brew link --overwrite node@20 -> node -v
